...
fun copyAssetToCache(context: Context, assetName: String): String {
    val assetSubPath = "paddle/$assetName" // use relative asset path
...
class DetectionPredictor : BasePredictor() {
    ...
    private lateinit var predictor : PaddlePredictor
    ...
    private val postprocessor = DBPostProcess(boxThresh = 0.6)
...
//            postprocessed.forEach { box ->
//                box.points.forEachIndexed { index, pts ->
//                    val mat = Mat()
//                    Utils.bitmapToMat(inputImage, mat)
//                    val cropped = cropFromBox(mat, pts, true)
